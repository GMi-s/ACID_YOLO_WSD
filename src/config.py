...
NUM_EPOCHS = 50
BATCH_SIZE = 8  # Уменьшенный размер батча
IMG_SIZE = 1080  # Уменьшенный размер изображения
...
INFERENCE_BATCH_SIZE = 8  # Размер батча для инференса
INFERENCE_IMAGE_SIZE = (1080, 1080)  # Размер изображения для инференса